...
import HeroBannerBitProtocol from "../../components/hero-banner/HeroBannerBitProtocol";
...
const BitProtocol = () => {
  return (
    <div className="main-page-wrapper font-gordita">
      ...
      <HeroBannerBitProtocol />
      {/* End Hero Banner BitProtocol */}
